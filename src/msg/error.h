...
//#define ERROR_ARGS ""
#define ERROR_NO_PATH "Path not specified\n"
#define ERROR_NO_BACKEND "No backend specified\n"
#define ERROR_NO_WALL_BACKEND "No backend specified for wallpaper\n"
...
#define ERROR_PROGRAM_NOT_FOUND "Program not found\n"
